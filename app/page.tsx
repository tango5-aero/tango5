    ...
    return (
        <main className="relative flex min-h-screen flex-col bg-[url('/images/map.jpg')] bg-center bg-no-repeat">
            <div className="my-20 flex flex-col items-center gap-20 p-6">
                <section className="justify-content flex max-w-[1200px] items-end gap-8">
                    ...
                    <div className="flex flex-col gap-4">
                        <span className="max-w-96 font-barlow text-4xl font-thin leading-none text-background dark:text-foreground xl:text-5xl 2xl:text-6xl">
                    ...
                    <div className="flex max-w-[600px] flex-col gap-6 text-pretty font-barlow text-2xl font-light leading-[1.2] text-background dark:text-foreground xl:text-3xl 2xl:text-[32px]">
                        <p className="pr-10">
                ...
                <section className="z-20 text-center font-barlow text-4xl font-thin text-background dark:text-foreground xl:text-5xl 2xl:text-6xl">
                    Who is it for?
                </section>
            ...
            <section className="z-20 mb-28 mt-10 flex items-center justify-center gap-4">
                ...
                />
                <div className="flex flex-col gap-2.5 font-barlow text-2xl font-light text-background dark:text-foreground xl:text-3xl 2xl:text-4xl">
            ...
            <footer className="mt-auto flex w-full flex-row items-center justify-between bg-translucent px-10 py-6">
                ...
                <div className="flex flex-row items-center justify-start gap-5">
                    <p className="font-barlow text-sm font-light text-background dark:text-foreground">
                        © 2025 DataBeacon
                    </p>
                </div>
